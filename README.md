...
- **Your classes, automatically.** Connect your Amizone account once and your timetable shows up with live countdowns and alarms. You log in on Amizone's own page; Clockdown never sees or stores your password.
- **Home screen widgets.** A live ticking timer, your next classes, or a list of what's coming up.
